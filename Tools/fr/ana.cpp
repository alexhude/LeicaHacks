...
#define I_BRANCH           0x00000400      // branch
#define I_ADDR_R           OP_ADDR_R
#define I_ADDR_W           OP_ADDR_W
#define I_IMM_MUL2         0x00001000      // imm = imm * 2
#define I_IMM_MUL4         0x00002000      // imm = imm * 4
#define I_IMM_4BIT         0x00004000      // imm = imm * 2
#define I_IMM_8BIT         0x00008000      // imm = imm * 4
    int flags;

    inline bool swap_ops(void) const { return flags & I_SWAPOPS; }
    inline bool delay_shot(void) const { return flags & I_DSHOT; }
	inline bool is_branch(void) const { return flags & I_BRANCH; }
...
static const struct opcode_t opcodes[] = {
    ...
    { fr_ld,        0x02,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_IMM_MUL4|I_IMM_8BIT },
    { fr_ld,        0x03,       S_8,    O_r15_imm4_i,   S_4,    O_gr,       S_4,        I_IMM_MUL4|I_IMM_4BIT },
    ...
    { fr_lduh,      0x04,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_IMM_MUL2|I_IMM_8BIT },
    { fr_ldub,      0x06,       S_8,    O_gri,          S_4,    O_gr,       S_4,        0         },
    { fr_ldub,      0x02,       S_8,    O_r13_gr_i,     S_4,    O_gr,       S_4,        0         },
    { fr_ldub,      0x06,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_IMM_8BIT },
    { fr_st,        0x14,       S_8,    O_gri,          S_4,    O_gr,       S_4,        I_SWAPOPS },
    { fr_st,        0x10,       S_8,    O_r13_gr_i,     S_4,    O_gr,       S_4,        I_SWAPOPS },
    { fr_st,        0x03,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_SWAPOPS|I_IMM_MUL4|I_IMM_8BIT },
    { fr_st,        0x13,       S_8,    O_r15_imm4_i,   S_4,    O_gr,       S_4,        I_SWAPOPS|I_IMM_MUL4|I_IMM_4BIT },
    ...
    { fr_sth,       0x05,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_SWAPOPS|I_IMM_MUL2|I_IMM_8BIT },
    { fr_stb,       0x16,       S_8,    O_gri,          S_4,    O_gr,       S_4,        I_SWAPOPS },
    { fr_stb,       0x12,       S_8,    O_r13_gr_i,     S_4,    O_gr,       S_4,        I_SWAPOPS },
    { fr_stb,       0x07,       S_4,    O_r14_imm8_i,   S_8,    O_gr,       S_4,        I_SWAPOPS|I_IMM_8BIT },
    ...
    { fr_bra,       0xE0,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bno,       0xE1,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_beq,       0xE2,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bne,       0xE3,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bc,        0xE4,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bnc,       0xE5,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bn,        0xE6,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bp,        0xE7,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bv,        0xE8,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bnv,       0xE9,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_blt,       0xEA,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bge,       0xEB,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_ble,       0xEC,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bgt,       0xED,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bls,       0xEE,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    { fr_bhi,       0xEF,       S_8,    O_rel,          S_8,    O_null,     0,          I_BRANCH  },
    ...
    { fr_bra,       0xF0,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bno,       0xF1,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_beq,       0xF2,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bne,       0xF3,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bc,        0xF4,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bnc,       0xF5,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bn,        0xF6,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bp,        0xF7,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bv,        0xF8,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bnv,       0xF9,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_blt,       0xFA,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bge,       0xFB,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_ble,       0xFC,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bgt,       0xFD,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bls,       0xFE,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
    { fr_bhi,       0xFF,       S_8,    O_rel,          S_8,    O_null,     0,          I_DSHOT|I_BRANCH },
	...
	{ fr_srch0,     0x97C,      S_12,   O_gr,           S_4,    O_null,     0,          0         }, // FR80 only
	{ fr_srch1,     0x97D,      S_12,   O_gr,           S_4,    O_null,     0,          0         }, // FR80 only
	{ fr_srchc,     0x97E,      S_12,   O_gr,           S_4,    O_null,     0,          0         }, // FR80 only
    ...
    { fr_enter,     0x0F,       S_8,    O_imm,          S_8,    O_null,     0,          I_IMM_MUL4|I_IMM_8BIT },
...
static int get_dr(const int num) {
    static int drs[] = {
        rTBR,
        rRP,
        rSSP,
...
static void set_imm(op_t &op, int imm, char d_typ, int flag=0) {
    op.type = o_imm;
	op.specflag1 |= flag;
    switch ( d_typ ) {
        case dt_byte:
			if (flag & OP_DISPL_IMM_UNSIGNED)
				op.value = (unsigned char) imm;
			else if (flag & OP_DISPL_IMM_SIGNED)
				op.value = (char) imm;
			else
				op.value = (char) imm;
			break;
...
static void set_displ(op_t &op, int reg, int imm, int flag, int local_flag, int dtyp) {
    op.type = o_displ;
    if ( reg != -1) op.reg = (uint16)get_gr(reg );
    if ( imm != -1 ) {
        int mul = 1;
		if (local_flag & I_IMM_8BIT)
		{
			if (imm & 0x80)
				imm |= 0xFFFFFF00;
		}
		else if (local_flag & I_IMM_4BIT)
		{
			if (imm & 0x08)
				imm |= 0xFFFFFFF0;
		}
		
		if ( local_flag & I_IMM_MUL4 )
			mul = 4;
        else if ( local_flag & I_IMM_MUL2 )
			mul = 2;

        op.value = ((int32_t) imm) * mul;
    }
    op.dtyp = dtyp;
    op.specflag1 |= flag;
}
...
#define set_displ_gr(op, gr, f1)			set_displ(op, gr, -1, f1, 0, 0)
#define set_displ_imm(op, imm, f1, f2, dt)  set_displ(op, -1, imm, f1, f2, dt)
...
static void fill_op(int data, op_t &op, int operand, int operand_size, int flags) {
    ...
    switch ( operand ) {
        ...
        case O_r14_imm8_i:   // indirect r14 + 8 bits immediate value    @(R14, imm)
            SWAP_IF_BYTE(data);
			if (cmd.itype == fr_ld || cmd.itype == fr_st)
				set_displ_imm(op, data, OP_DISPL_IMM_R14, flags, dt_dword);
			else if (cmd.itype == fr_lduh || cmd.itype == fr_sth)
				set_displ_imm(op, data, OP_DISPL_IMM_R14, flags, dt_word);
			else if (cmd.itype == fr_ldub || cmd.itype == fr_stb)
				set_displ_imm(op, data, OP_DISPL_IMM_R14, flags, dt_byte);
			else
				set_displ_imm(op, data, OP_DISPL_IMM_R14, flags, dt_byte);
            break;
        ...
        case O_r15_imm4_i:   // indirect r15 + 4 bits immediate value    @(R15, imm)
            SWAP_IF_BYTE(data);
			if (cmd.itype == fr_ld || cmd.itype == fr_st)
				set_displ_imm(op, data, OP_DISPL_IMM_R15, flags, dt_dword);
			else if (cmd.itype == fr_lduh || cmd.itype == fr_sth)
				set_displ_imm(op, data, OP_DISPL_IMM_R15, flags, dt_word);
			else if (cmd.itype == fr_ldub || cmd.itype == fr_stb)
				set_displ_imm(op, data, OP_DISPL_IMM_R15, flags, dt_byte);
			else
				set_displ_imm(op, data, OP_DISPL_IMM_R15, flags, dt_byte);
            break;
        ...
        case O_imm:          // immediate value                          #i
            {
				...
				{
					data *= 4;
					set_imm(op, data, dtypes[operand_size], OP_DISPL_IMM_UNSIGNED);
				}
				else if ( cmd.itype == fr_add2 || cmd.itype == fr_addn2 || cmd.itype == fr_cmp2)
				{
					data |= 0xF0; // extn(data) to 8bits
					set_imm(op, data, dtypes[operand_size], OP_DISPL_IMM_SIGNED);
				}
				else if (cmd.itype == fr_addsp)
				{
					data = ((signed) data ) * 4;
					set_imm(op, data, dtypes[operand_size], OP_DISPL_IMM_SIGNED);
				}
...
static bool ana_special(int data) {
    ...
    if ( ((data & 0xFF00) >> 8) == 0x9F ) {
        ...
        switch ( (data & 0x00F0) >> 4 ) {
            ...
            // copop
            case 0xC:   cmd.itype = fr_copop;
                        set_cr(cmd.Op3, (word & 0x00F0) >> 4);
                        set_cr(cmd.Op4, word & 0x000F);
                        break;

            // copld
            case 0xD:   cmd.itype = fr_copld;
                        set_gr(cmd.Op3, (word & 0x00F0) >> 4);
                        set_cr(cmd.Op4, word & 0x000F);
                        break;

            // copst
            case 0xE:   cmd.itype = fr_copst;
                        set_cr(cmd.Op3, (word & 0x00F0) >> 4);
                        set_gr(cmd.Op4, word & 0x000F);
                        break;

            // copsv
            case 0xF:   cmd.itype = fr_copsv;
                        set_cr(cmd.Op3, (word & 0x00F0) >> 4);
                        set_gr(cmd.Op4, word & 0x000F);
                        break;
        }
...
int idaapi ana(void) {
    ...
    bool success = ana_special(byte);
    if ( !success )
        success = ana_common(byte);
